...
const AllEventsPage = () => {
  ...
  const filteredEvents = React.useMemo(() => {
    ...
    return filtered;
  }, [events, filterType, selectedCategory, sortOrder, selectedMonth, selectedDateRange, selectedPrice, selectedMode]);

  const pageTitle = filterType ? `${filterType} Fairs` : 'Upcoming Events';
      ...
      <div className="flex-grow pt-30 pb-20">
        <div className="w-full max-w-[1400px] mx-auto px-4 ">
          ...
          <div className="flex-shrink-0 mb-8">
                ...
                <p className="text-sm text-gray-500">Showing {filteredEvents.length} events</p>
          </div>
